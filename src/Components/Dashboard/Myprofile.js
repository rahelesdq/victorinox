    ...
    <div className="flex">
      ...
      <div className="mt-[100px]    ">
        ...
        <div className="flex ml-[290px] text-2xl mt-[50px]">
          ...
          <input
            class="sm:w-full border-gray-500 border-2 ml-[325px] pl-2 h-[48px]	 	"
            type="text"
          ></input>
        </div>
        <div className="flex ml-[290px] text-2xl mt-[50px]">
          <span>Surname*</span>
          <input
            class="sm:w-full border-gray-500 border-2 ml-[295px] pl-2 h-[48px]	"
            type="text"
          ></input>
        </div>
        <div className="flex ml-[290px] text-2xl mt-[50px]">
          <span>Nickname*</span>
          <input
            class="sm:w-full border-gray-500 border-2 ml-[287px] pl-2 h-[48px]		"
            type="text"
          ></input>
        </div>
        <div className="flex ml-[290px] text-2xl mt-[50px]">
        ...
        <div className="flex ml-[290px] text-2xl mt-[50px]">
          ...
          <select
            id="month"
            name="month"
            class="ml-[127px]  w-[253px]  px-3  bg-white border-b-2 border-black  shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
          >
            <option>1</option>
            <option>2</option>
            <option>3</option>
          ...
          <select
            id="day"
            name="day"
            class=" w-[253px]  px-3  bg-white border-b-2 border-black  shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
          >
            <option>1</option>
            <option>2</option>
            <option>3</option>
