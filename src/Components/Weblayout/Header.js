  ...
  return (
    <div>
      ...
      <div className="header-2 h-28">
        <nav className="bg-white  md:py-4 border-solid border-gray-300 border-b">
          <div className="container px-4  md:flex md:items-center flex justify-between">
            ...
            <div class="bg-red hidden lg:flex   lg:mt-6 md:ml-60 md:mt-10 text-lg font-normal xl:ml-56  flex-col lg:flex-row  mt-3 md:mt-2">
              <div className="container  md:flex md:items-center lg:justify-between flex ">
                <div class="bg-red hidden lg:flex   lg:mt-12 md:mt-10 text-lg font-normal xl:ml-56  flex-col lg:flex-row  mt-3 md:mt-2">
                  <div class=" p-2 lg:px-4 sm:mx-2 lg:w-48 md:w-44  text-gray-600 rounded hover:bg-gray-200 hover:text-gray-700 transition-colors duration-300 itemhover menu1">
